...
<head>
  ...
  <title>Offices</title>
  @vite([ 'resources/css/sidebar.css', 'resources/js/sidebar.js', 'resources/css/office.css'])
</head>
      ...
      <table id="example" class="table table-hover table-light table-borderless">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <button type="button" class="btn btn-outline-primary btn-sm" data-bs-toggle="modal" data-bs-target="#editModal" data-id="{{ $office->id }}" data-name="{{ $office->Office_Name }}" data-pin="{{ $office->Office_pin }}">Update
      ...
      <div class="modal-body">
        <form id="addForm" method="POST" action="{{ route('offices.store') }}">
          ...
          <div class="mb-3">
            ...
            <input type="number" class="form-control" id="new-office-pin" name="pin">
          </div>
        </form>
      </div>
