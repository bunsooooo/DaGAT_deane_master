...
<head>
  <meta charset="UTF-8">
  @vite(['resources/css/app.css', 'resources/css/about.css', 'resources/css/sidebar.css', 'resources/css/usermanagement.css'], 'resources/js/sidebar.js')
  <!-- Boxiocns CDN Link -->
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <button class="btn btn-outline-dark btn-sm" data-bs-toggle="modal" data-bs-target="#deleteModal"
...
<script>
  document.addEventListener('DOMContentLoaded', function () {
    ...
    deleteModal.addEventListener('show.bs.modal', function (event) {
      ...
      var userName = deleteModal.querySelector('#delete-user-name');
      var deleteForm = deleteModal.querySelector('#deleteForm');

      userName.textContent = name;
      deleteForm.action = '{{ route('user.delete', '') }}/' + id;
    });
  });
</script>
</body>
